...
?>
			<span class="<?=($first ? "pager-page-first " : "")?>modern-page-current"><?=$pageNumber?></span>
<?
		elseif($page == $arResult["PAGE_COUNT"]):
?>
			<a href="<?=htmlspecialcharsbx($arResult["URL"])?>" class="<?=($first ? "pager-page-first" : "")?>"><?=$pageNumber?></a>
<?
		else:
?>
			<a href="<?=htmlspecialcharsbx($component->replaceUrlTemplate($page))?>" class="<?=($first ? "pager-page-first" : "")?>"><?=$pageNumber?></a>
<?
		endif;
...
<?
	...
	do
	{
		if ($page == $arResult["CURRENT_PAGE"]):
?>
			<span class="<?=($first ? "pager-page-first " : "")?>modern-page-current"><?=$page?></span>
<?
		elseif($page == 1):
?>
			<a href="<?=htmlspecialcharsbx($arResult["URL"])?>" class="<?=($first ? "pager-page-first" : "")?>">1</a>
<?
		else:
?>
			<a href="<?=htmlspecialcharsbx($component->replaceUrlTemplate($page))?>" class="<?=($first ? "pager-page-first" : "")?>"><?=$page?></a>
<?
		endif;
